...
If you want to report an issue or a bug you've encountered while using tuifeed, open an issue using the `Bug report` template.
...
The first thing you should do though, is not starting to write the code, but is to become concern about how tuifeed works, what kind
